...
import com.example.localticketingsystem.Traveldata.Registeration;
import com.example.localticketingsystem.Traveldata.RegisteratoinLab;
import com.example.localticketingsystem.Traveldata.UserDetails;

public class SelectPage extends AppCompatActivity {
    public static final String userDetails = "com.example.localticketingsystem.userDetails";
    public static final String userId = "com.example.localticketingsystem.userId";
    public static final String userBalance = "com.example.localticketingsystem.userbalance";
    public static final String s = "com.example.localticketingsystem.userbalance.s";
    public static final String s1 = "com.example.localticketingsystem.userbalance.s1";
